  ...
  useEffect(() => {
    ...
    class MouseClass {
      constructor() {
        ...
        this.smoothCoords = new THREE.Vector2();
      ...
      startSmoothUpdate() {
        ...
        const smoothUpdate = () => {
          ...
          if (distance > 0.001) {
            this.rafId = requestAnimationFrame(smoothUpdate);
          } else {
            this.coords.copy(this.targetCoords);
            this.smoothCoords.copy(this.targetCoords);
            this.rafId = null;
          }
        };
      ...
      onDocumentMouseMove(event) {
        ...
        const currentTime = performance.now();
        if (currentTime - this.lastMouseTime < this.throttleDelay) {
          return;
        }
