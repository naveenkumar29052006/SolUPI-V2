...
export default function SignUpPage() {
        ...
        try {
            ...
            if (data.success) {
                ...
                toast({
                    type: 'error',
                    title: 'Signup Failed',
                    message: data.error || "Could not create account. Please try again."
                })
            }
        } catch (error) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6 py-12 pt-20 relative pointer-events-auto overflow-hidden bg-[#0a0a0a]">
            <div className="w-full max-w-sm space-y-6 relative z-10">
                {/* Cyberpunk Signup Form */}
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-2 text-sm bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#CCFF00] focus:border-transparent transition-all duration-200"
                                        placeholder="Naveen"
                                    />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="w-full px-3 py-2 pr-10 text-sm bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#CCFF00] focus:border-transparent transition-all duration-200"
                                ...
                                <AnimatedCheckbox
                                    ...
                                    label={
                                        <span className="text-xs">
                                            I agree to the{' '}
                                            <Link href="/terms" className="transition-colors" style={{ color: '#CCFF00' }}>
                                                Terms of Service
                                            </Link>{' '}
                                            and{' '}
                                            <Link href="/privacy" className="transition-colors" style={{ color: '#CCFF00' }}>
                                                Privacy Policy
                                            </Link>
                                        </span>
                                    }
